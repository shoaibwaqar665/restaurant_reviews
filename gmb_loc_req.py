...
url = "https://www.google.com/search?tbm=map&authuser=0&hl=en&q=" + query
payload = {}
headers = {
  'accept': '*/*',
...
input_file = f'{file_name}_google_loc_response.json'
...
output_file = f'{file_name}_google_loc_cleaned.json'
